-- Xinfa Paint Factory Management System: initial Flyway schema.
-- Flyway is already connected to the target database; this migration creates tables only.
...
CREATE TABLE dispatch_sheet (
  ...
  CONSTRAINT ck_dispatch_status CHECK (status IN ('DRAFT','APPROVED','COMPLETED','VOIDED'))
) ENGINE=InnoDB;
