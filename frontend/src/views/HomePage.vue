        ...
        <div class="dashboard-row">
          <article class="panel todo-panel">
            ...
            <el-table :data="todos" border size="small">
              <el-table-column prop="type" :label="$t('home.businessType')" width="116" class-name="business-type-column"/><el-table-column prop="label" :label="$t('home.tasks')" min-width="160"/>
...
:deep(.business-type-column .cell){white-space:nowrap}
